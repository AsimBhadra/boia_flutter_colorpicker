...
class AppColorTextField extends StatefulWidget {
  const AppColorTextField({
    required this.color,
  ...
  @override
  State<AppColorTextField> createState() => _AppColorTextFieldState();
}

class _AppColorTextFieldState extends State<AppColorTextField> {
  bool _inputFieldHasValidationError = false;
  Color _floatingLabelTextColor = Color(0xff1C2035);
  ...
  void initState() {
    focusNode.addListener(() {
      if (focusNode.hasFocus && !_hasFocus) {
        _hasFocus = true;
        setState(() {});
      } else {
        if (_hasFocus) {
  ...
  InputDecoration _getInputDecoration() => InputDecoration(
        focusColor: const Color(0xff366cf8),
        prefixIcon: const Padding(
          padding: EdgeInsets.only(right: 8, bottom: 8),
        ),
        // suffixIcon: widget.suffixIcon ?? _getSuffixIcon(show: false),
        suffixIconConstraints: const BoxConstraints(maxHeight: 18),
        prefixIconConstraints: const BoxConstraints(maxHeight: 22),
        isDense: true,
        contentPadding: const EdgeInsets.fromLTRB(14, 22, 15, 0),
  ...
  Padding _getLabelText() {
    ...
    return Padding(
      ...
      child: Text(widget.labelText, style: _getLabelStyle()),
    );
  }

  TextStyle _getErrorStyle() => TextStyle(
        fontSize: 12,
        fontWeight: FontWeight.w400,
        color: Color(0xffF8705E),
        fontFamily: 'Satoshi',
        height: 1,
      );

  TextStyle _getHintStyle() => TextStyle(
        fontSize: 16,
        fontWeight: FontWeight.w400,
  ...
  TextStyle _getLabelStyle() => TextStyle(
        fontSize: 12,
  ...
  TextStyle _getFloatingLabelStyle() => TextStyle(
        fontSize: 12,
        fontWeight: FontWeight.w400,
        color: _floatingLabelTextColor,
        fontFamily: 'Satoshi',
      );

  Color _getLabelTextColor() {
    if (_inputFieldHasValidationError || widget.errorText != null) {
      return Color(0xffF8705E);
    }
    return Color(0xff697089);
  }
}
        ...
        SizedBox(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              isDense: true,
              hintText: widget.embeddedText ? 'HEX code' : null,
